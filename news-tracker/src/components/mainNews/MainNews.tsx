...
import { NewsImage } from "../shared/newsImage/NewsImage.tsx"
      ...
      <section className={styles.MainNewsBlock}>
          ...
          <article className={styles.sideColumnMainNewsBlock}>
            ...
            >
              <div className={styles.sideImgWrapper}>
                <NewsImage src={firstColumnNews[0]?.urlToImage} alt={firstColumnNews[0]?.title} />
              </div>
        ...
        <div className={styles.sideBlock}>
          <article className={styles.sideColumnMainNewsBlock}>
            ...
            >
              <div className={styles.sideImgWrapper}>
                <NewsImage src={thirdColumnNews[0]?.urlToImage} alt={thirdColumnNews[0]?.title} />
              </div>
              <span draggable={false} className={styles.sideColumnMainNewsText}>
