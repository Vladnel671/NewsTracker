    ...
    return (
        <motion.div
            ...
            <article className={styles.newsContainer} key={title}>
                <a draggable={false} className={styles.newsLink} href={url} target="_blank"
                   rel='noopener noreferrer'>
                    {urlToImage && <div className={styles.newsPictureContainer}>
                    ...
                    <div className={styles.allNewsItemText}>
                        ...
                        <div className={styles.sourceNamePublishedBlock}>
                            <h4 className={styles.source}>
                                {author && <span className={styles.AuthorBlock}>{author}.&nbsp;{source?.name}</span>}
                            </h4>
